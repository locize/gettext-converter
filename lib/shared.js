...
// keys that must never be used as dynamic object keys to avoid prototype pollution
 ...
 */
export const formatCharset = (charset = 'iso-8859-1', defaultCharset = 'iso-8859-1') => {
